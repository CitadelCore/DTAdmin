          ...
          if (checkUserHasPermission($mysqli, $_SESSION['user_id'], 'canmodifyusers') == true) : ?>
            <div class="container-fluid">
              ...
              <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline">
                <thead>
                  <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-sort="none" aria-label="Actions: activate to sort column descending" style="width: 250px;">Actions</th>
